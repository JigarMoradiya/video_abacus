...
try:
    ...
    # Not installed here. fw_backend provides the same surface on faster-whisper —
    # see its docstring for the accuracy caveat (ASR, not true forced alignment).
    sys.path.insert(0, str(Path(__file__).resolve().parent))
    import fw_backend as stable_whisper

    print("stable_whisper missing — using faster-whisper backend", file=sys.stderr)
