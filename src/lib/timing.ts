// Data-driven timing engine, shared by every episode.
// Instead of hand-counting BEATS frame tables (the old reels' approach), this reads
// the recorded word-level narration timings (src/data/<episode>.phrases.json, produced by
...
// Phrases are always passed in explicitly here: the phonics version defaulted to one
// episode's JSON, which made it easy to build a reel against the wrong timing file.
